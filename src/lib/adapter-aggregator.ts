...
const HOST_MAP: Record<string, string> = {
  emby: "your-media-host",
  sonarr: "your-media-host",
  radarr: "your-media-host",
  sabnzbd: "your-storage-host",
  romm: "your-media-host",
  tdarr: "your-media-host",
  "disc-ripper": "your-media-host",
  omdb: "external (omdbapi.com)",
  omniroute: "your-arm-host",
  litellm: "your-arm-host",
  ollama: "your-gpu-host",
  comfyui: "your-gpu-host",
  "hermes-workspace": "your-vps-host",
  "hermes-gateway": "your-vps-host",
  "hermes-api-server": "your-vps-host",
  "hermes-dashboard": "your-vps-host",
  "hermes-mcp-bridge": "your-vps-host",
  honcho: "your-arm-host",
  openwebui: "your-arm-host",
  "openwebui-api": "your-arm-host",
  "openwebui-vector": "your-arm-host",
  "agent-vault": "your-vps-host",
  cognee: "your-arm-host",
  langfuse: "your-vps-host",
  opencode: "your-vps-host",
  "home-assistant": "your-media-host",
  mqtt: "your-media-host",
  "node-red": "your-media-host",
  wyoming: "your-media-host",
  "stalwart-mail": "your-vps-host",
  roundcube: "your-vps-host",
  vikunja: "your-vps-host",
  outline: "your-vps-host",
  telegram: "your-vps-host",
  prometheus: "your-vps-host",
  loki: "your-vps-host",
  alertmanager: "your-vps-host",
  grafana: "your-vps-host",
  alloy: "your-vps-host",
  cadvisor: "your-vps-host",
  blackbox: "your-vps-host",
  "uptime-kuma": "your-vps-host",
  ntfy: "your-vps-host",
  docker: "fleet",
  systemd: "fleet",
  "watchtower-vps": "your-vps-host",
  "watchtower-media": "your-media-host",
  "watchtower-storage": "your-storage-host",
  spoolman: "your-media-host",
  "node-exporter": "fleet",
  gpu: "your-gpu-host",
  tailscale: "mesh",
  pihole: "LAN",
  ...
  "iot-vlan": "LAN",
  onepanel: "your-vps-host",
  valkey: "your-vps-host",
  searxng: "your-vps-host",
  "garage-s3": "your-vps-host",
  "synology-dsm": "your-storage-host",
  "smb-nfs": "your-storage-host",
  syncthing: "your-storage-host",
  caddy: "your-vps-host",
  "wazuh-manager": "your-vps-host",
  "wazuh-indexer": "your-vps-host",
  "wazuh-dashboard": "your-vps-host",
  fail2ban: "your-arm-host",
  "1password": "cloud",
  wiki: "local",
  obsidian: "local",
  ...
  spotify: "cloud",
  calendar: "cloud",
  "spoolman-personal": "your-media-host",
  scenes: "your-media-host",
};
  ...
  const enrichments: Partial<Record<WorldId, Record<string, Partial<VisualQueryResult>>>> = {
    ...
    ops: {
      ...
      docker: {
        ...
        items: [
          { id: "c1", label: "searxng", subtitle: "your-vps-host • running", state: "healthy" },
          { id: "c2", label: "valkey", subtitle: "your-vps-host • running", state: "healthy" },
          { id: "c3", label: "caddy", subtitle: "your-vps-host • running", state: "healthy" },
          { id: "c4", label: "watchtower", subtitle: "your-vps-host • running", state: "healthy" },
        ],
      },
    },
    infrastructure: {
      "node-exporter": {
        ...
        items: [
          { id: "host1", label: "your-vps-host", subtitle: "VPS • 4 vCPU • 8GB", state: "healthy" },
          { id: "host2", label: "your-media-host", subtitle: "LAN • 8 CPU • 32GB", state: "healthy" },
          { id: "host3", label: "your-storage-host", subtitle: "DS1817+ • 16GB", state: "healthy" },
          { id: "host4", label: "your-arm-host", subtitle: "ARM64 • 4GB", state: "warning" },
        ],
      },
      tailscale: {
        ...
        nodes: [
          { id: "ts1", label: "your-vps-host", x: 200, y: 80, state: "healthy" },
          { id: "ts2", label: "your-media-host", x: 100, y: 200, state: "healthy" },
          { id: "ts3", label: "your-storage-host", x: 300, y: 200, state: "healthy" },
          { id: "ts4", label: "your-arm-host", x: 200, y: 320, state: "warning" },
          { id: "ts5", label: "your-git-host", x: 400, y: 120, state: "healthy" },
        ],
        edges: [
    ...
    security: {
      "wazuh-manager": {
        ...
        events: [
          { id: "e1", at: "2026-07-29 10:15", title: "SSH brute-force blocked", detail: "fail2ban: 192.0.2.42 banned", state: "warning" },
          { id: "e2", at: "2026-07-29 09:42", title: "Root login detected", detail: "your-vps-host from 203.0.113.10", state: "healthy" },
    ...
    knowledge: {
      wiki: {
        ...
        items: [
          { id: "d1", label: "your-vps-host", subtitle: "Infrastructure • updated 2h ago", state: "healthy" },
          { id: "d2", label: "owner", subtitle: "People • updated 5h ago", state: "healthy" },
