...
// real source for it: GET /containers/json?all=1. Point WATCHTOWER_STORAGE_URL
...
function makeFreshness(): FreshnessInfo {
  return {
    ...
    source: WATCHTOWER_STORAGE_URL || "unconfigured",
  ...
  async query(): Promise<VisualQueryResult> {
    ...
    if (!WATCHTOWER_STORAGE_URL) {
      return {
        ...
        summary: "Set WATCHTOWER_STORAGE_URL to a Docker Engine API or socket-proxy endpoint.",
      };
    }
